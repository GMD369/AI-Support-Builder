    ...
    <div className="p-8">
      ...
      <div className="mb-6 flex items-start justify-between">
        ...
        <button
          ...
          className="rounded-xl bg-[#0A4F8F] px-5 py-2.5 text-sm font-bold text-white transition-colors hover:bg-[#1D7FC4]"
        >
          + Create Bot
        </button>
      </div>
      ...
      {bots.length === 0 && !showCreate ? (
        <div className="rounded-xl border border-dashed border-[#BAE6FD] p-16 text-center">
          ...
          <button
            onClick={() => setShowCreate(true)}
            className="mt-5 rounded-xl bg-[#0A4F8F] px-5 py-2.5 text-sm font-bold text-white hover:bg-[#1D7FC4]"
          >
            + Create Bot
          </button>
        </div>
          ...
          {bots.map((bot) => (
            ...
            >
              <div className="mb-3 flex items-center gap-3">
                <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-[#F0F9FF] text-xl">
                  🤖
                </div>
              ...
              <div className="mt-3 text-xs font-semibold text-[#38B2F0]">
                Open →
              </div>
              <button
